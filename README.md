...
- [Лучшие практики AGENTS.md для разработчиков](Лучшие%20практики%20AGENTS.md%20для%20разработчиков.md) — стратегия внедрения и архитектурные паттерны стандарта AGENTS.md
