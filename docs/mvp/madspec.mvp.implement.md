...
5. Для UI-шагов реализация сверяется с утвержденными screen-прототипами, flow steps и входным экраном из `ui-prototype/`.
...
- UI реализуется "примерно похоже", но расходится с утвержденными screen-прототипами, flow steps или входным экраном без обновления `mvp.design`
