...
- собирает проверки из валидации рабочего состояния памяти, предварительных инвариантов планирования и реализации, а также пользовательских правил проекта
