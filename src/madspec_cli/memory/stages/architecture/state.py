...
from .renderers import (
    render_architecture_markdown_document,
    render_data_model_markdown_document,
    render_openapi_yaml_document,
)
from .shared import (
    ...
    normalize_required_flag as _normalize_required_flag,
    normalize_string as _normalize_string,
    normalize_string_list as _normalize_string_list,
)
from ..design.state import FLOW_DATA_KINDS, normalize_design_state
...
def render_architecture_markdown(
    ...
    *,
    ...
    normalized, _ = normalize_architecture_state(state)
    return render_architecture_markdown_document(
        normalized,
...
def render_data_model_markdown(
    ...
    *,
    ...
    normalized, _ = normalize_architecture_state(state)
    return render_data_model_markdown_document(
        normalized,
        branch_name=branch_name,
        project_name=project_name,
    )
