...
def ensure_memory_layout(
    ...
    *,
    ...
    from ..stages.design.state import default_design_state, load_design_state, save_design_state
    from ..stages.tech.state import default_tech_state, load_tech_state, save_tech_state
