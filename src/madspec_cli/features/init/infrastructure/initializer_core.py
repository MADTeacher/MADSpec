...
def download_template_from_github(
    ...
    *,
    ...
    try:
        ...
        console.print(Panel(str(exc), title="Available Assets", border_style="yellow"))
                            ...
                            if dest_path.exists():
                                for sub_item in item.rglob("*"):
                                    ...
                                    if dest_file.name == "settings.json" and dest_file.parent.name == ".vscode":
                                        handle_vscode_settings(sub_item, dest_file, rel_path, verbose=verbose, tracker=tracker)
                                    else:
                                        shutil.copy2(sub_item, dest_file)
                            else:
