...
Перед тем как давать рекомендации, получи актуальный архитектурный контекст через `madspec agents subagents context --subagent-id architecture --toon-output`.
