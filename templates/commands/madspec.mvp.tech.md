---
description: MVP - Этап 2 - Выбор технологического стека с обоснованием и обсуждением
handoffs: 
...
На этом этапе **MADSpec (MADSpec Framework)** выбирается технологический стек для **MVP (Minimum Viable Product)** проекта. Это критически важный этап, так как необходимо понимать **ПОЧЕМУ** выбираются те или иные технологии, а не просто следовать рекомендациям.
...
- Если файлы отсутствуют, предложи выполнить предыдущие этапы MVP (`/madspec.mvp.concept`, `/madspec.mvp.design`)
...
После выбора технологий переходите к `/madspec.mvp.architecture` для проектирования архитектуры и структуры проекта.
