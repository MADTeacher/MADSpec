...
Этот этап является отправной точкой для всего проекта в рамках **MADSpec (MADSpec Framework)**. Здесь определяется **ЧТО** необходимо создать и **ПОЧЕМУ**, без погружения в технические детали.
...
6. **Обновление project-context.md**:
   - Создай/обнови `.madspec/project-context.md` из шаблона `.madspec/templates/project-context-template.md`
   - Заполни:
     - Название проекта
...
7. **Сохранение файлов**:
   - Сохрани `.madspec/concept.md`
   - Сохрани `.madspec/project-context.md` (только навигация)
...
После завершения этого этапа необходимо перейти к `/madspec.design` для работы над видением графического пользовательского интерфейса на основе концепции реализуемой системы
