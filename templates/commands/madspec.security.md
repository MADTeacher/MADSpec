...
Эта команда **MADSpec (MADSpec Framework)** выполняет комплексную проверку безопасности кода проекта на соответствие стандартам OWASP и законодательству по персональным данным. Команда поддерживает настраиваемый scope проверки для разных уровней сложности и образовательных целей.

## Предварительные условия

- **Должен существовать** реализованный код проекта (хотя бы частично)
- **Должен существовать** `.madspec/tech-stack.md` для понимания технологического стека
- **Должен существовать**`.madspec/architecture.md` для анализа архитектурных решений безопасности
...
- Если кода нет и не указан `--skip-artifacts`, сообщи студенту и предложи выполнить `/madspec.implement`
...
- Проверь существование `.madspec/tech-stack.md`
- Проверь существование `.madspec/architecture.md`
- Проверь существование `.madspec/concept.md`
- Проверь существование `.madspec/data-model.md` (опционально)
...
**Загрузка артефактов:**
- Прочитай `.madspec/tech-stack.md`, если он существует
- Прочитай `.madspec/architecture.md`, если он существует
- Прочитай `.madspec/concept.md`, если он существует
- Прочитай `.madspec/data-model.md`, если он существует
...
**Сохранение отчета:**
- Сохрани отчет в `.madspec/security-audit.md`
...
**Обновление project-context.md**:
   - Обнови `.madspec/project-context.md`:
     ...
     - Добавь ссылку на отчет `.madspec/security-audit.md`

### 6. Вывод результатов

Выведи студенту:
- Путь к отчету: `.madspec/security-audit.md`
